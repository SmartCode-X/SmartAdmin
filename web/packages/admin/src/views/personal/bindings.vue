...
/* n-card 默认边框/底色就是 --color-border / --color-bg-container(见 theme/naive-theme.ts),
   所以「未绑定」态什么都不用写;圆角同样由 Card.borderRadius = --radius-lg 给。 */
.bind-card :deep(.n-card-content) {
  display: flex;
