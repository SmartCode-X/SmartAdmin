    ...
    IRoleGrantPolicy? roleGrantPolicy = null) : IImportProfile
{
    ...
    [
        ...
        new()
        {
            ...
            // 导入自然也该是下拉而不是自由文本(用户实测反馈)。挂上字典即可,
