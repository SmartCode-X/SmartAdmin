...
/// <para>类 public、方法 virtual:自定义机构规则(如接第三方组织架构同步)时继承覆写。</para>
/// </summary>
public interface IOrgService
{
    ...
    /// <summary>按 Id 取单个机构,不存在则抛 <see cref="SmartAdmin.Core.ErrorCode.OrgNotFound"/></summary>
    ...
    /// </summary>
    /// <param name="id">源机构 Id(要克隆的子树根)</param>
