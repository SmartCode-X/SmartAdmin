...
/// 启用条件:<c>Security:Session:CookieMode</c>;默认 body refresh。
/// </summary>
public static class AuthCookieNames
{
    /// <summary>HttpOnly 刷新令牌 Cookie</summary>
    public const string RefreshToken = "smart_rt";

    /// <summary>可读 CSRF Cookie(双提交)</summary>
    public const string Csrf = "smart_csrf";

    /// <summary>客户端须回传的 CSRF 请求头</summary>
    public const string CsrfHeader = "X-Smart-CSRF";
}
