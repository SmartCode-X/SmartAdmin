...
/// <summary>单元格级错误。<b>只带码不带文案</b>:前端按 code 查 i18n 渲染。</summary>
...
{
    /// <summary>提交的数据总行数。</summary>
    public int Total { get; set; }
    /// <summary>新插入的行数。</summary>
    public int Inserted { get; set; }
    /// <summary>覆盖更新的行数(<see cref="DuplicateStrategy.Overwrite"/> 策略下)。</summary>
    public int Updated { get; set; }
    /// <summary>跳过的行数(<see cref="DuplicateStrategy.Skip"/> 策略下已存在的行)。</summary>
...
{
    /// <summary>Excel sheet 名。</summary>
    public string SheetName { get; set; } = "Sheet1";
    /// <summary>导出的列声明。</summary>
...
{
    /// <summary>模板文件的 sheet 名。</summary>
    public string SheetName { get; set; } = "数据";
    /// <summary>模板包含的列声明。</summary>
    public IReadOnlyList<ImportColumn> Columns { get; set; } = [];
...
/// <summary>导入重验 / 错误报告入参:前端改过的行原样带回。</summary>
public sealed class ImportRowsInput
{
    /// <summary>前端改过、待重验的数据行。</summary>
...
{
    /// <summary>待提交的数据行。</summary>
    public List<ImportRow> Rows { get; set; } = [];
    /// <summary>重复处理策略,默认 <see cref="DuplicateStrategy.Skip"/>。</summary>
