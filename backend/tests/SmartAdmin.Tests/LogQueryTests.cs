...
/// <summary>
/// 日志的"可查性"——审计日志要能回答"谁在什么时候干了什么",否则等于没有:
/// <para>操作日志可按操作人 / 时间范围 / 接口路径筛,不止操作名模糊 + 成败;登录日志可按时间范围筛。</para>
/// <para>操作人被软删(=离职)后,历史日志仍显示其姓名,而不是回落成一串雪花 Id
...
public class LogQueryTests
{
    ...
    public async Task Deleted_user_still_shows_name_in_history()
    {
        ...
        // [ActiveSession] 端点,无需权限码;是个写操作 → 现在会留痕
